...
void setupparams(
    ...
    int& JitterProfComp, int& incProfileEnergyEvo, double* ProfileEnergyEvoPrior, int& debug,
    ...
    int& incProfileScatter, int& ScatterPBF)
{
    ...
    try {
        ...
        parameters.readInto(WhiteSolarWindPrior[0], "WhiteSolarWindPrior[0]",
                            WhiteSolarWindPrior[0]);
        parameters.readInto(WhiteSolarWindPrior[1], "WhiteSolarWindPrior[1]",
                            WhiteSolarWindPrior[1]);
        ...
        for (int i = 0; i < incDMShapeEvent; i++) {
            ...
            parameters.readInto(DMEventLengthPrior[2 * i + 1], buffer,
                                DMEventLengthPrior[2 * i + 1]);
        }
        ...
        parameters.readInto(incDMScatterShapeEvent, "incDMScatterShapeEvent",
                            incDMScatterShapeEvent);
        parameters.readInto(numDMScatterShapeCoeff, "numDMScatterShapeCoeff",
                            numDMScatterShapeCoeff);
        parameters.readInto(DMScatterShapeCoeffPrior[0], "DMScatterShapeCoeffPrior[0]",
                            DMScatterShapeCoeffPrior[0]);
        parameters.readInto(DMScatterShapeCoeffPrior[1], "DMScatterShapeCoeffPrior[1]",
                            DMScatterShapeCoeffPrior[1]);
        ...
        parameters.readInto(BandNoiseAlphaPrior[0], "BandNoiseAlphaPrior[0]",
                            BandNoiseAlphaPrior[0]);
        parameters.readInto(BandNoiseAlphaPrior[1], "BandNoiseAlphaPrior[1]",
                            BandNoiseAlphaPrior[1]);
        ...
        parameters.readInto(GroupNoiseAlphaPrior[0], "GroupNoiseAlphaPrior[0]",
                            GroupNoiseAlphaPrior[0]);
        parameters.readInto(GroupNoiseAlphaPrior[1], "GroupNoiseAlphaPrior[1]",
                            GroupNoiseAlphaPrior[1]);
        ...
        parameters.readInto(ProfileEnergyEvoPrior[0], "ProfileEnergyEvoPrior[0]",
                            ProfileEnergyEvoPrior[0]);
        parameters.readInto(ProfileEnergyEvoPrior[1], "ProfileEnergyEvoPrior[1]",
                            ProfileEnergyEvoPrior[1]);
        ...
        parameters.readInto(LinearProfileWidthPrior[0], "LinearProfileWidthPrior[0]",
                            LinearProfileWidthPrior[0]);
        parameters.readInto(LinearProfileWidthPrior[1], "LinearProfileWidthPrior[1]",
                            LinearProfileWidthPrior[1]);
        ...
        parameters.readInto(ProfileNoiseAmpPrior[0], "ProfileNoiseAmpPrior[0]",
                            ProfileNoiseAmpPrior[0]);
        parameters.readInto(ProfileNoiseAmpPrior[1], "ProfileNoiseAmpPrior[1]",
                            ProfileNoiseAmpPrior[1]);
        parameters.readInto(ProfileNoiseSpecPrior[0], "ProfileNoiseSpecPrior[0]",
                            ProfileNoiseSpecPrior[0]);
        parameters.readInto(ProfileNoiseSpecPrior[1], "ProfileNoiseSpecPrior[1]",
                            ProfileNoiseSpecPrior[1]);
        ...
        parameters.readInto(incTimeCorrProfileNoise, "incTimeCorrProfileNoise",
                            incTimeCorrProfileNoise);
...
void GetProfileFitInfo(char* ConfigFileName, int numProfComponents, int* numGPTAshapecoeff,
                       ...
                       int* numTimeCorrCoeff, int incExtraComp, double** FitForExtraComp,
                       int* FitCompWidths, int* FitCompPos)
{
    ...
    for (int i = 0; i < incExtraComp; i++) {
        ...
        try {
            ...
            parameters.readInto(FitForExtraComp[i][2], buffer,
                                FitForExtraComp[i][2]);  // Include Phase Equivalent
            //                        n=sprintf (buffer, "FitForBand[%i][3]", i);
            //                      parameters.readInto(FitForBand[i][3], buffer, FitForBand[i][3]);
